			...
			if [ ! -f ssarp_eval$suffix.txt ]; then
				...
				../.././updateRows.pl ../lac_train_TUBE$suffix.txt lac_train_TUBEfinal.txt $j
 				cp lac_train_TUBEfinal.txt lac_train_TUBE$suffix.txt
				                                ...
				                                ../../create_partition_files.pl lac_train_TUBE$suffix.txt ../features_train_TUBE$suffix.txt $partitions "features_"
				
				
                                                                ../../create_partition_files.pl alac_lac_train_TUBE$suffix.txt ../features_train_TUBE$suffix.txt $partitions "alac_features_"
